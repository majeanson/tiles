...
import { blind, farm, hoard, POLICIES, randomLegal, rush, survivor } from './policy';
...
describe('what the harness proved about the design', () => {
   ...
   *
   * So rule 5's timing decision is currently fake, and it is pinned here as fake
   * so that a future fix has something to flip.
   */
